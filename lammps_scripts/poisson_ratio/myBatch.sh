#!/bin/bash
#SBATCH --job-name=chpoi40inc          # Job name
#SBATCH --output=lammps_output.log     # Output log file
#SBATCH --error=lammps_error.log       # Error log file
#SBATCH --nodes=1                      # Number of nodes
#SBATCH --ntasks-per-node=2            # Number of tasks per node (adjust as needed)
#SBATCH --time=15:30:00                # Time limit (hh:mm:ss) adjust this based on your job's needs
